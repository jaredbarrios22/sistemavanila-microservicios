 ...
 */
@Entity
public class ReportePedidosActivos {
    @Id
    ...
    public ReportePedidosActivos(){
        
    }
    
    public ReportePedidosActivos(int numerogestion, String usuario, double total, Date fecha_solicitud, boolean aplica_oferta, String descripcion, String municipio, String departamento, String estado){
